...
| -p P<br>--processes P           | Sets the number of processes to **P**.                | 15                             |
| -d S<br>--duration S            | Sets the duration of view to **S** seconds.           | Video duration.                |
| -pr PATH<br>--proxies PATH      | Sets the path to the list of proxies to **PATH**.     | Proxies list from internet.    |
